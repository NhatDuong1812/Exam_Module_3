    ...
    <div class="row">
        <div class="col-md-6">
            <a href="${pageContext.request.contextPath}/admin/products?act=create"
               ...
               data-toggle="tooltip" data-placement="top" title="Add New Product"><i class="fa fa-plus"></i> Add
                New Product</a>
        </div>
        <div class="col-md-6">
            <form action="${pageContext.request.contextPath}/admin/products" method="get"
                ...
                <button type="submit" class="btn btn-primary mb-2" data-toggle="tooltip" data-placement="top"
                        title="Filter"><i class="fa fa-search"></i> Search
                </button>
            </form>
        </div>
    </div>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold"><i class='fas fa-list'></i>
                    ${title}</h6>
                </div>
                <div class="card-body">
                    ...
                    <c:choose>
                        <c:when test="${requestScope['products'].size() == 0}">
                            <div class="alert alert-info">No data, <a
                                    href="${pageContext.request.contextPath}/admin/products">Refresh page</a></div>
                        </c:when>
                        <c:otherwise>

                            <% if (request.getParameter("query") != null) { %>
                            <div class="alert alert-info">Found ${requestScope['products'].size()} results for the
                                keyword: <strong><%=request.getParameter("query")%>
                                </strong>, <a href="${pageContext.request.contextPath}/admin/products">Refresh page</a>
                            </div>
                            <% } %>
                                    ...
                                    <c:forEach items="${requestScope['products']}" var="product">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="${pageContext.request.contextPath}/admin/products?act=delete&id=${product.getId()}"
